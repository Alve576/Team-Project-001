...
export default function PrimarySearchAppBar() {
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" style={{backgroundColor : 'white',color : "#3BB77E",padding:'40px'}}>
        <Toolbar>
          <Typography
            variant="h6"
            noWrap
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            <IconButton size="large" aria-label="show 4 new mails" color="inherit" >
              <Badge badgeContent={4} color="error">
                <Favorite />
                    <Link style={{textDecoration : 'none', color : '#3BB77E'}} to='/wishlist'>
                        Wishlist
                    </Link>
              </Badge>
            </IconButton>
            ...
            >
              <Login />
                <Link style={{textDecoration : 'none', color : '#3BB77E'}} to='/login'>
                    Login
                </Link>
            </IconButton>
          </Box>
